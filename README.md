# Spring Boot Reactive gRPC Sample

This project is a Spring gRPC server with [reactive-grpc](https://github.com/salesforce/reactive-grpc). Build and run any way you like to run Spring Boot. E.g:
